# Provisioning Alcatel-Lucent Enterprise

This is a guide to auto-provision a [Alcatel-Lucent Enterprise (ALE)](https://www.aledevice.com/site/desktop_phone).
...
3. Obtain Phone’s IP Address
    - Once the device is restore to its defaults, search for the device's IP address. The IP address is needed in order to provision a ALE phone, you will first need to get its IP address to access the phone's web interface.
    - The IP address on ALE devices can easily be found by pressing the OK button on the phone. You should see a Status screen with a line containing the IP address, for example: `IPv4: 10.10.9.88`. Please make sure that your device jack is plugged in. If it is not plugged in, the IP address will not be displayed as expected.
4. Enter the IP Address and Login
    ...
    ![Alcatel-Lucent Enterprise Start](./images/ale-start.png)
5. Autoprovision Device
    ...
    ![Alcatel-Lucent Enterprise Auto Provision](./images/ale-auto-provision.png)
    ...
    ![Alcatel-Lucent Enterprise Submit](./images/ale-submit.png)
    ...
    ![Alcatel-Lucent Enterprise End](./images/ale-end.png)